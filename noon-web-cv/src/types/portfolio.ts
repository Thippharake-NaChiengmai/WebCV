...
export interface Project { id: number; images: ProjectImage[]; title: string; description: string; technologies: string[]; features: string[]; challenges: string[]; results: string[]; category?: string; startDate?: string; endDate?: string; status?: ProjectStatus; githubUrl?: string; youtubeUrl?: string; websiteUrl?: string; figmaUrl?: string; download?: ProjectDownload; liveUrl?: string; }
